...
//add tooltip to svg
  ...
  var annotations = [{
    ...
    x: 290 + margin.left, y: 40 + margin.bottom * 0.25,
    dy: -15,
    dx: 0,
    ...
    x: 580 + margin.left, y: 160 + margin.bottom * 0.25,
    dy: -15,
    dx: 0,
    ...
    x: 798 + margin.left, y: 176 + margin.bottom * 0.25,
    dy: -15,
    dx: 0,
    ...
    x: 798 + margin.left, y: 516 + margin.bottom * 0.25,
    dy: -15,
    dx: 0,
