...
*/
    ...
    g.selectAll(".dot")
     ...
     function onclick_antiblackbias(d,i){
          ...
          updateRaceBiasMotivationsBar("#racebiasbar-svg", bias_subcategory, barchartColor, titlePrefix);
     }
...
*/
    ...
    function onclick_antijewish(d,i){
          ...
          console.log("onclick event triggered for Dominant Hate Biases Line Chart. Bias Motivation Subcategory: " + bias_subcategory + " bar chart color: " + barchartColor + " title prefix: " + titlePrefix);
          updateReligionBiasMotivationsBar("#religionbiasbar-svg", bias_subcategory, barchartColor, titlePrefix);
     }
...
function renderRaceBiasMotivationsBarFirstTime(svgId, race_bias_motivation_subcategory, barchartColor, titlePrefix){
...
//add variable and properties for tooltip 
  var tip = d3.tip()
    ...
    .offset([-10, 0])
    .html(function(d) {
      return "Race or Ethnicity of Offender: " + d.Race_Ethnicity_Of_Offender + "<br> Percent of Offenses: "  + d.Percent_Of_Offenses * 100 + " %";
    });
...
//add tooltip to svg
  ...
  g.selectAll("text")
    ...
    .append("text")
    .text(function(d) {
      return d.Percent_Of_Offenses * 100 + " %";
  })
...
function updateRaceBiasMotivationsBar(svgId, religion_bias_motivation_subcategory, barchartColor, titlePrefix) {
   console.log("updateRaceBiasMotivationsBar function invoked with a Bias Motivation Category of " + religion_bias_motivation_subcategory + " and barchart color: " + barchartColor + " and titlePrefix: " + titlePrefix);


}

function updateReligionBiasMotivationsBar(svgId, religion_bias_motivation_subcategory, barchartColor, titlePrefix) {
   console.log("updateReligionBiasMotivationsBar function invoked with a Bias Motivation Category of " + religion_bias_motivation_subcategory + " and barchart color: " + barchartColor + " and titlePrefix: " + titlePrefix);


}

function renderReligionBiasMotivationsBarFirstTime(svgId, religion_bias_motivation_subcategory, barchartColor, titlePrefix) {
   console.log("renderReligionBiasMotivationsBar function invoked with a Bias Motivation Category of " + religion_bias_motivation_subcategory + " and barchart color: " + barchartColor + " and titlePrefix: " + titlePrefix);
   renderRaceBiasMotivationsLine(svgId);
  ...
  renderRaceBiasMotivationsBarFirstTime("#racebiasbar-svg", "ALL","lightgrey", "Race Based");
  renderReligionBiasMotivationsBarFirstTime("#religionbiasbar-svg", "ALL", "lightgrey", "Religion Based");
