...
*/
    ...
    g.selectAll(".dot")
     ...
     function onclick_antiblackbias(d,i){
          ...
          console.log("onclick event triggered for Dominant Hate Biases Line Chart. Bias Motivation Subcategory: " + bias_subcategory);
          renderRaceBiasMotivationsBar("#racebiasbar-svg", bias_subcategory);
     }
...
*/
    ...
    function onclick_antijewish(d,i){
          ...
          console.log("onclick event triggered for Dominant Hate Biases Line Chart. Bias Motivation Subcategory: " + bias_subcategory);
          renderReligionBiasMotivationsBar("#religionbiasbar-svg", bias_subcategory);
     }
...
function renderRaceBiasMotivationsBar(svgId, race_bias_motivation_subcategory){
  console.log("renderRaceBiasMotivationBar function invoked with a Bias Motivation Category of " + race_bias_motivation_subcategory);
  renderRaceBiasMotivationsLine(svgId);
}

function renderReligionBiasMotivationsBar(svgId, religion_bias_motivation_subcategory) {
   console.log("renderReligionBiasMotivationsBar function invoked with a Bias Motivation Category of " + religion_bias_motivation_subcategory);
   renderRaceBiasMotivationsLine(svgId);
  ...
  renderRaceBiasMotivationsBar("#racebiasbar-svg", "Anti-Black");
  renderReligionBiasMotivationsBar("#religionbiasbar-svg", "Anti-Jewish");
