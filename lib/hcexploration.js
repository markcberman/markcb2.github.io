...
function renderReligionBiasMotivationsBar(svgId, religion_bias_motivation_subcategory, barchartColor) {
  ...
  renderRaceBiasMotivationsBar("#racebiasbar-svg", "ALL","lightgrey");
  renderReligionBiasMotivationsBar("#religionbiasbar-svg", "ALL", "lightgrey");
