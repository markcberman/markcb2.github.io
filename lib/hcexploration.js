...
function renderReligionBiasMotivationsBarFirstTime(svgId, religion_bias_motivation_subcategory, barchartColor, titlePrefix) {
  ...
  renderRaceBiasMotivationsBarFirstTime("#racebiasbar-svg", "Race-Ethnicity-Ancestry","lightgrey", "Race Based");
  renderRaceBiasMotivationsBarFirstTime("#religionbiasbar-svg", "Religion", "lightgrey", "Religion Based");
