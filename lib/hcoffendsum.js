...
function renderRaceBiasMotivationsBarFirstTime(svgId, race_bias_motivation_subcategory, barchartColor, titlePrefix, bartCharId, titleId){
 ...
 //set up annotations
   ...
   var annotations = [{
    note: {
      align: "right",
      label: "Blacks and African Americans make up 13.6 % of the U.S. Population.  They commit fewwer hate crimes relative to their representation in the U.S. population",
    ...
    note: {
      align: "left",
      label: "Hispanics make up 16.3 % of the U.S. Population.  They commit fewer hate crimes relative to their there representation in the population",
      title: "Hispanics"
    },
  ...
  },
  {
    note: {
      align: "right",
      label: "Whites make up 72.4 % of the U.S. Population.  They commit fewer hate crimes relative to their there representation in the population",
      title: "Whites"
    },
